...
var text_name = block.getFieldValue('NAME');  // Get the I2C address from the block

    Blockly.Arduino.definitions_['define_lcd'] = '#include <Wire.h>\n#include <LiquidCrystal_I2C.h>\n';
    Blockly.Arduino.definitions_['define_lcdpins'] = 'LiquidCrystal_I2C lcd('+text_name+',16,2);\n';
    Blockly.Arduino.setups_['setup_lcdi2c']='lcd.init();\n lcd.backlight();\n'
